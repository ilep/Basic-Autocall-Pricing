...
def test_call_price_close_to_check():
    ...
    random_paths = RandomPaths(model="black-scholes", T=call.T, delta_t=1./(2*365), vol=.2, mu=r, S0=10, n_simulations=100000)
    ...
    assert abs(price_to_be_checked - check_price) / check_price < 1e-3
